...
public static abstract class Stub extends android.os.Binder implements com.homework3.fibonaccicommon.IFibonacciService
{
private static final java.lang.String DESCRIPTOR = "com.homework3.fibonaccicommon.IFibonacciService";
...
/**
 * Cast an IBinder object into an com.homework3.fibonaccicommon.IFibonacciService interface,
 * generating a proxy if needed.
 */
public static com.homework3.fibonaccicommon.IFibonacciService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.homework3.fibonaccicommon.IFibonacciService))) {
return ((com.homework3.fibonaccicommon.IFibonacciService)iin);
}
return new com.homework3.fibonaccicommon.IFibonacciService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
com.homework3.fibonaccicommon.FibonacciRequest _arg0;
if ((0!=data.readInt())) {
_arg0 = com.homework3.fibonaccicommon.FibonacciRequest.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
com.homework3.fibonaccicommon.FibonacciResponse _result = this.fib(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
private static class Proxy implements com.homework3.fibonaccicommon.IFibonacciService
{
...
@Override public com.homework3.fibonaccicommon.FibonacciResponse fib(com.homework3.fibonaccicommon.FibonacciRequest request) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.homework3.fibonaccicommon.FibonacciResponse _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
if ((request!=null)) {
_data.writeInt(1);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.homework3.fibonaccicommon.FibonacciResponse.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public com.homework3.fibonaccicommon.FibonacciResponse fib(com.homework3.fibonaccicommon.FibonacciRequest request) throws android.os.RemoteException;
}
